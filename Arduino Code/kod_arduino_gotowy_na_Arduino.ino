...
float liczba1_os_x= normAccel.XAxis;
  ...
  {
  //  Serial.print(" XI = ");
   // Serial.print(normAccel.XAxis); //znormalizowany pomiar z osi x
 // Serial.print(wynik_x);
   // Serial.print(" YYYI = ");
  //  Serial.print(normAccel.YAxis); //znormalizowany pomiar z osi y
  // Serial.print(wynik_y);
Serial.println("1");
  // Serial.print(" ZZZI = ");
  // Serial.println(wynik_z);   
  //  Serial.println(normAccel.ZAxis); //znormalizowany pomiar z osi z
